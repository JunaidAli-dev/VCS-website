...
const modules = [
  {
    id: 1,
    module: 1,
    label: "Foundations of Venture Capital",
    topic: "Intro, Firm, Finances",
    zIndex: 10,
  ...
  },
  {
    id: 2,
    module: 2,
    label: "Understanding Startups and Funding Pipeline",
    topic: "Ecosystem, Diligence",
    zIndex: 10,
  ...
  },
  {
    id: 3,
    module: 3,
    label: "Deal Structuring and Portfolio Management",
    topic: "Investments, Term Sheets, Portfolio Management",
    zIndex: 10,
  ...
  },
  {
    id: 5,
    module: 5,
    label: "Career and Global VC Perspective",
    topic: "Career, VC, Assignments",
    zIndex: 20,
  ...
  },
  {
    id: 4,
    module: 4,
    label: "Advanced Tools, Pitches and Emerging Trends",
    topic: "Pitch Eval, Tools, Future of VC",
    zIndex: 10,
...
const moduleData = {
  1: [
    {
      day: "Day 1",
      content: "Introduction to Venture Capital",
      task1: "Introduction to Venture Capital",
      task2: "History and Evolution0",
      task3: "VC as aCareer (basic intro)",
    },
    {
      day: "Day 2",
      content: "Inside a VC Firm",
      task1: "Working and Structure of a VC firm",
      task2: "",
      task3: "",
    },
    {
      day: "Day 3",
      content: "VC Finances",
      task1: "How do VCs make money?",
      task2: "Stages of Funding: Angel, VC, Entry & Exit",
      task3: "Investment Strategy and Thesis",
    },
  ],
  2: [
    {
      day: "Day 4",
      content: "The Startup Ecosystem",
      task1: "Startup Ecosystem's Elements & Key Players",
      task2:
        "Market Analysis (TAM/ SAM/ SOM, Unit Economics, Competitive Moats) & Startup Business Models",
      task3: "Process of VC Funding (overview) & Parameters of Investing",
    },
    {
      day: "Day 5",
      content: "Due Diligence",
      task1: "Due Diligence Types",
      task2: "Due Diligence - Key metrics & KPIs to verify",
      task3: "Practical Template for Due Diligence",
    },
    {
      day: "Day 6",
      content: "Data and Deal Flow",
      task1: "Sourcing Data & Tools for Sourcing (LinkedIn, Pitchbook)",
      task2: "Pipeline Building, Lead Tracking",
      task3: "Power of Networking",
    },
  ],
  3: [
    {
      day: "Day 7",
      content: "Investment Process and Deal Types",
      task1: "Process of VC Funding (in detail)",
      task2: "Deal Types (Equity, Convertible Notes, SAFE, Term Sheets)",
      task3: "",
    },
    {
      day: "Day 8",
      content: "Term Sheets and Portfolio Management",
      task1: "Introduction to Valuation (Pre-money and Post-money)",
      task2:
        "Term Sheets & Cap tables (Equity, Dilution, Dilution examples, Liquidation preference, ESOPs)",
      task3: "Basics of Finance Modeling, Portfolio and Risk Management",
    },
  ],
  4: [
    {
      day: "Day 9",
      content: "Career in Venture Capital",
      task1: "VC as a Career (detailed)",
      task2: "How to Get into a VC Firm",
      task3: "Analyst to Associate Growth Track",
    },
    {
      day: "Day 10",
      content: "Venture Capital in India and Abroad",
      task1: "VC in India (Landscape) - Indian VC ecosystem overview",
      task2: "Global VC Models, Indian VC Culture vs Global VC Culture",
      task3: "Impact of Global Events on VC Ecosystem",
    },
    {
      day: "Day 11",
      content: "Applied Assignment",
      task1: "Assignment (Investment Memo/ Mock Deal Recommendation)",
      task2: "",
      task3: "",
    },
  ],
  5: [
    {
      day: "Day 12",
      content: "Pitch Evaluation",
      task1: "How to evaluate pitch decks",
      task2: "Red flags in startup pitches",
      task3: "Elements of a Perfect Pitch",
    },
    {
      day: "Day 13",
      content: "VC Tools and Platforms",
      task1: "VC Tools: Notion, Airtable, Pitchbook, Carta",
      task2: "Practical Demonstration / Workflow Simulation",
      task3: "",
    },
    {
      day: "Day 14",
      content: "Future of Venture Capital",
      task1:
        "New Emerging trends: AI in VC, Climate Tech, Micro-VCs, Rolling funds",
      task2: "",
      task3: "",
    },
    {
      day: "Day 15",
      content: "Done! Congrats!",
      task1: "",
      task2: "",
      task3: "",
    },
      ...
      <section className="relative flex flex-col-reverse lg:flex-row items-center justify-between min-h-[90vh] px-4 md:px-8 pt-6 sm:pt-12 py-12">
        ...
        <div className="hidden lg:block relative w-full max-w-3xl h-[70vh]">
          {modules.map((item) => (
            <div
              key={item.id}
              className="absolute bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 w-64 transition-all duration-300 hover:border-cyan-400/50 hover:shadow-2xl hover:shadow-cyan-500/10"
        ...
        <div className="lg:hidden flex justify-start gap-3 px-2 overflow-x-auto pb-4 w-full">
          {modules.map((item) => (
            <div
              key={item.module}
              className="bg-card border border-border rounded-lg p-3 min-w-[140px] flex-shrink-0 text-left"
            >
      ...
      >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {courseModules.map((module, index) => (
            <Card
              key={module.module}
              className="p-6 bg-card/50 backdrop-blur-sm border-border hover:border-blue-400 transition-all duration-300 group"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-full bg-cyan-500/10 flex items-center justify-center border border-cyan-500/20 group-hover:border-cyan-400 transition-colors">
                  <span className="text-cyan-400 font-bold ">
                    {module.module}
                  </span>
                </div>
                <div className="text-lg font-bold border-b-2 border-blue-500/50 pb-1">MODULE {module.module}</div>
              </div>
          ...
          {/* Hackathon card */}
          <Card className="p-6 bg-gradient-to-br from-blue-500/10 to-cyan-500/5 backdrop-blur-sm border-blue-400 hover:shadow-[0_0_40px_rgba(34,211,238,0.4)] transition-all duration-300 group sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
      ...
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-base sm:text-lg">
            Explore the daily breakdown of each module
          </p>
        </div>
        ...
        <div className="w-full">
          <Tabs
            ...
            onValueChange={(v) => setSelectedModule(parseInt(v))}
            className="w-full"
          >
            <TabsList className="grid w-full h-fit grid-cols-3 sm:grid-cols-6 mb-8 bg-card border border-border overflow-x-auto scrollbar-hide">
              {[1, 2, 3, 4, 5].map((module) => (
                <TabsTrigger
                  ...
                  className="data-[state=active]:bg-cyan-500 data-[state=active]:text-white text-sm sm:text-base px-2 sm:px-4"
                >
                  Module {module}
                </TabsTrigger>
              ))}
                    ...
                    <Table className="min-w-[700px] sm:min-w-full text-sm sm:text-base">
                      <TableHeader>
                        <TableRow className="bg-card hover:bg-card">
                          <TableHead className="w-[80px] sm:w-[100px] font-bold">
                            Day
                          </TableHead>
                      ...
                      <TableBody>
                        {moduleData[module as keyof typeof moduleData].map(
                          (day, index) => (
                            <TableRow
                              key={index}
                              className="hover:bg-cyan-500/5 transition-colors"
                            >
                              <TableCell className="font-semibold text-cyan-400 whitespace-nowrap">
                                {day.day}
                              </TableCell>
